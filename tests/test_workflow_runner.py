...
class TestWorkflowRunnerTriggerWorkflow:
    """Tests for WorkflowRunner.trigger_workflow"""

    @patch("framework.workflow_runner.WorkflowRunner._start")
    @patch("framework.workflow_runner.main")
